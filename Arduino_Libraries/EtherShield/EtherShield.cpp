...
void EtherShield::ES_send_udp(uint8_t *buf,char *data,uint8_t datalen,uint16_t sport, uint8_t *dip, uint16_t dport, uint8_t *udpmac){
    send_udp(buf, data, datalen, sport, dip, dport, udpmac);
}
///
...
void EtherShield::ES_fill_buf_p(uint8_t *buf,uint16_t len, const char * const progmem_s PROGMEM) {
...
uint16_t EtherShield::ES_fill_tcp_data_p(uint8_t *buf,uint16_t pos, const char * const progmem_s PROGMEM){
...
#ifdef WWW_client
    // ----- http get
void EtherShield::ES_client_browse_url(const char *urlbuf, char *urlbuf_varpart, const char *hoststr,
        void (*callback)(uint8_t,uint16_t,uint16_t)) {
    client_browse_url(urlbuf, urlbuf_varpart, hoststr, callback);
}

void EtherShield::ES_client_http_post(const char *urlbuf PROGMEM, const char *hoststr PROGMEM, const char *additionalheaderline PROGMEM,
        const char *method PROGMEM, char *postval,void (*callback)(uint8_t,uint16_t,uint16_t)) {
...
//void EtherShield::ES_dnslkup_request(uint8_t *buf,const char *progmem_hostname PROGMEM) {
...
uint8_t EtherShield::ES_enc28j60GetLastError(void){
    return enc28j60GetLastError();
}
